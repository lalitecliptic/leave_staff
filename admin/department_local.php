...
<?php 
	 if (isset($_GET['delete'])) {
		...
		$sql = "DELETE FROM tbldepartments_local where id = ".$department_id;
 ...
 if(isset($_POST['add']))
{
	...
	$deptshortname=$_POST['departmentshortname'];
     ...
     $query = mysqli_query($conn,"select * from tbldepartments_local where DepartmentName = '$deptname'")or die(mysqli_error());
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into tbldepartments_local (DepartmentName, DepartmentShortName)
  		 values ('$deptname', '$deptshortname')      
		") or die(mysqli_error()); 

		if ($query) {
			echo "<script>alert('Department Added Successfully');</script>";
			echo "<script type='text/javascript'> document.location = 'department_local.php'; </script>";
		}
    }
								...
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										...
										<tbody>
											...
											<?php $sql = "SELECT * from tbldepartments_local";
											...
											<tr>
												...
												<td>
													<div class="table-actions">
														<a href="edit_department_local.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
														<a href="department_local.php?delete=<?php echo htmlentities($result->id);?>" data-color="#e95959"><i class="icon-copy dw dw-delete-3"></i></a>
													</div>
												</td>
											</tr>
